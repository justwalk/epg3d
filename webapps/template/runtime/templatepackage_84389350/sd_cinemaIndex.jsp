...
<script type="text/javascript">
	...
	function getfocus(objId){
		...
		if(objId.substr(0,objId.length-3) == "left" || objId.substr(0,objId.length-3) == "r_left"){
 			var r_left = document.getElementById("r_"+objId.substr(0,objId.length-2)+"_img_div").style.left;
			//var rLeft = r_left.substr(0,r_left.length-2);
			var r_left_text = document.getElementById("r_"+objId.substr(0,objId.length-2)+"_text").style.left;
			var rLeft = parseInt(r_left);
			var rLeftText = parseInt(r_left_text);
			document.getElementById("r_"+objId.substr(0,objId.length-2)+"_img_div").style.left = (parseInt(rLeft)+10)+"px";
			document.getElementById("r_"+objId.substr(0,objId.length-2)+"_text").style.left = (parseInt(rLeftText)+10)+"px";
		}
		// 中间1 r_centerOne1_a
		if(objId.substr(0,objId.length-2) == "centerOne1" || objId.substr(0,objId.length-2) == "centerTwo1" || objId.substr(0,objId.length-2) == "centerThree1"){
			...
			var titlediv = parseInt(_titlediv);
		...
		if(objId.substr(0,objId.length-3) == "downfocus"){
			...
			var r_down_img_div = parseInt(_r_down_img_div);
			...
			var r_downfocus1_img_div = parseInt(_r_downfocus1_img_div);
...
<epg:body onload="init();" bgcolor="#000000" width="1280" height="720">
	...
	<div id="leftDiv">
		...
		<epg:grid column="1" row="10" left="31" top="219" width="120" height="430" vcellspacing="15" items="${leftCategoryItems}" var="leftCategoryItem" indexVar="curIdx" posVar="positions">
			...
			<epg:text id="left${curIdx}_text" color="#ffffff" left="${positions[curIdx-1].x+10}" align="left" top="${positions[curIdx-1].y+9}" width="100" fontSize="16" chineseCharNumber="9" dotdotdot="…">
		...
		<epg:if test="${centerOneCategoryItems!=null}">
			...
			<div id="centerOne1_titlediv" style="position: absolute; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left:165px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff"  left="2" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerOneCategoryItems.title}</epg:text>
			</div>
		...
		<epg:grid column="1" row="2" left="165" top="324" width="140" height="54" vcellspacing="10" items="${centerOneCharCategoryItems}" var="centerOneCharCategoryItem" indexVar="curIdx" posVar="positions">
			...
			<epg:text color="#ffffff"  left="${positions[curIdx-1].x}" align="left" top="${positions[curIdx-1].y}" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerOneCharCategoryItem.title}</epg:text>
		...
		<epg:if test="${centerTwoCategoryItems!=null}">
			...
			<div id="centerTwo1_titlediv" style="position: absolute;overflow:hidden; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left: 315px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff" left="-5" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerTwoCategoryItems.title}</epg:text>
			</div>
		...
		<epg:grid column="1" row="2" left="315" top="324" width="140" height="54" vcellspacing="10" items="${centerTwoCharCategoryItems}" var="centerTwoCharCategoryItem" indexVar="curIdx" posVar="positions">
			...
			<epg:text color="#ffffff"  left="${positions[curIdx-1].x}" align="left" top="${positions[curIdx-1].y}" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerTwoCharCategoryItem.title}</epg:text>
		...
		<epg:if test="${centerThreeCategoryItems!=null}">
			...
			<div id="centerThree1_titlediv" style="position: absolute; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left: 465px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff" left="-5" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerThreeCategoryItems.title}</epg:text>
			</div>
		...
		<epg:grid column="1" row="2" left="465" top="324" width="140" height="54" vcellspacing="10" items="${centerThreeCharCategoryItems}" var="centerThreeCharCategoryItem" indexVar="curIdx" posVar="positions">
			...
			<epg:text color="#ffffff"  left="${positions[curIdx-1].x}" align="left" top="${positions[curIdx-1].y}" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerThreeCharCategoryItem.title}</epg:text>
	...
	<div id="rightDiv">
		...
		<!-- 导航 -->
		<epg:grid column="7" row="1" left="760" top="90" width="505" height="39" hcellspacing="35" items="${menuCategoryItems}" var="menuCategoryItem" indexVar="curIdx" posVar="positions">
			<epg:navUrl obj="${menuCategoryItem}" indexUrlVar="indexUrl" />
			<epg:if test="${curIdx==1}">
		...
		<epg:grid column="1" row="10" left="671" top="219" width="120" height="430" vcellspacing="15" items="${leftCategoryItems}" var="leftCategoryItem" indexVar="curIdx" posVar="positions">
			<epg:navUrl obj="${leftCategoryItem}" indexUrlVar="indexUrl" />
			<div style="overflow: hidden;">
			<epg:text id="r_left${curIdx}_text" color="#ffffff" left="${positions[curIdx-1].x+10}" align="left" top="${positions[curIdx-1].y+9}" width="100" fontSize="16" chineseCharNumber="9" dotdotdot="…">
				<div style="overflow:hidden">${leftCategoryItem.title}</div>
			</epg:text>
			</div>
		...
		<epg:if test="${centerOneCategoryItems!=null}">
			...
			<div id="r_centerOne1_titlediv" style="position: absolute; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left:805px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff" left="2" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerOneCategoryItems.title}</epg:text>
			</div>
			<epg:navUrl obj="${centerOneCategoryItems}" indexUrlVar="indexOneUrl1" />
		...
		<epg:if test="${centerTwoCategoryItems!=null}">
			...
			<div id="r_centerTwo1_titlediv" style="position: absolute; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left:955px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff" left="-5" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerTwoCategoryItems.title}</epg:text>
			</div>
			<epg:navUrl obj="${centerTwoCategoryItems}" indexUrlVar="indexTwoUrl1" />
		...
		<epg:if test="${centerThreeCategoryItems!=null}">
			...
			<div id="r_centerThree1_titlediv" style="position: absolute; font-size: 16px; color: #FFFFFF; opacity: 0.7; text-align: center; background-color: #020000; left:1105px; top: 286px; width: 140px; height: 30px; z-index: 1;">
				<epg:text color="#ffffff"  left="-5" align="left" width="140" fontSize="16" chineseCharNumber="12" dotdotdot="…">${centerThreeCategoryItems.title}</epg:text>
			</div>
			<epg:navUrl obj="${centerThreeCategoryItems}" indexUrlVar="indexThreeUrl1" />
