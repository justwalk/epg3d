...
<epg:resource realSrcVar="proBtnImg" src="./images/HLW_HDplay.png"/>
...
<%-- 
  id           NUMBER not null,
  rel_name     VARCHAR2(150), 	--包名
  rel_code     VARCHAR2(50),	--包code
  content_code VARCHAR2(50),	--contentCode
  video_type   NUMBER,			--视频类型   1、HD      0、SD        2、3D
  body_type    NUMBER,			--内容类型   1、正片   2、预告片  3、片花
  audio_type   NUMBER,			--声音类型   1、原声   2、国语    3、粤语
  status       NUMBER default 0,	--0: 正常    1删除
  type         VARCHAR2(50)			-- 剧集 ：单剧集 vod   多剧集series
...
<epg:img left="0" top="0" width="1280" height="720" src="./images/HLW_detailBg.jpg"/>
...
<!-- title -->
<div id="proTitle">
	<epg:text width="348" text="${program.title}" fontSize="30" color="#80D0FF"/>
</div>
...
<epg:text id="dddddddddddd"  left="436" top="279" width="540" height="22" chineseCharWidth="27" dotdotdot="…">
	<epg:choose>
...
<div id="btnLayer_0" style="left:369;width:155px;">
	<epg:img id="btn0Img" left="0" top="513" width="155" height="35" src="./images/HLW_HDplay.png" href="javascript:serviceAuth(0,'btn0Img');" defaultfocus="true"/>
	<epg:text id="btn0Txt" left="17" top="518" width="40" height="35" text="${HDProgram.suggestedPrice}" fontSize="24" align="center"/>
</div>

<div id="btnLayer_1" style="left:554;width:155px;">
	<epg:img id="btn1Img" left="0" top="513" width="155" height="35" src="./images/HLW_SDplay.png" href="javascript:serviceAuth(1,'btn1Img');"/>
	<epg:text id="btn1Txt" left="12" top="518" width="40" height="35" text="${SDProgram.suggestedPrice}" fontSize="24" align="center"/>
</div>

<div id="btnLayer_2" style="left:739;width:116px;">
	<epg:img id="btn2Img" left="0" top="513" width="116" height="35" src="./images/HLW_preview.png" href="${playUrl}" rememberFocus="true"/>
</div>

<!-- back -->
<div id="btnLayer_3" style="left:554px; width:97px;">
	<epg:img id="btn3Img" left="0" top="513" width="97" height="35" src="./images/HLW_return.png" href="javascript:back();" />
</div>

<!-- tip -->
<div id="tipLayer">
	<epg:img left="0" top="0" width="1280" height="720" src="./images/HLW_tip.png"/>
	<!-- still -->
	...
	<!-- price -->
	<div id="price"></div>
	<epg:img id="order" left="461" top="513" width="120" height="35" src="${dot}" href="#"/>
	<epg:img id="authOrderTip" left="701" top="513" width="120" height="35" src="${dot}" href="javascript:closeTip(0);"/>
</div>
