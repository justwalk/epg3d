 	...
 	<!-- 栏目图片 -->
   	<epg:grid column="6" row="2" left="110" top="220" width="960" height="405" hcellspacing="32" vcellspacing="20" items="${category}" var="categoryItem"  indexVar="rowStatus" posVar="positions">
	 	<epg:if test="${categoryItem!=null}">
			...
			<epg:img id="focus_${rowStatus-1}"src="./images/dot.gif"  href="${indexUrl}&returnTo=biz" rememberFocus="true" left="${positions[rowStatus-1].x-10}" top="${positions[rowStatus-1].y-7}" width="155" height="209"   onfocus="itemOnFocus('focus_${rowStatus-1}','nurseryContent');" onblur="itemOnBlur('focus_${rowStatus-1}');" />
		</epg:if>
    </epg:grid>
</div>
</epg:body>
