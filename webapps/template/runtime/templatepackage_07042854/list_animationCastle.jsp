...
<!-- 获取栏目图片  -->
<epg:query queryName="getSeverialItemsIncludePic" maxRows="12" var="category" pageBeanVar="pageBean" pageIndexParamVar="pageIndex" pageTurnIsLoop="true" >
 ...
 <div id="main">
  <!--导航条start-->
   <div id="Navigation" style="position:absolute;width:530px;height:52px;left:323px;top:108px;"> 
	...
	<epg:img id="menu0" height="52" width="99" href="${indexUrl}" rememberFocus="true" src="./images/dot.gif" onfocus="itemOnFocus('menu0','cartoonCastleMenuFocus');" onblur="itemOnBlur('menu0');"/>
	</epg:if>
	</div>
	...
	<epg:img id="menu1" height="52" width="84" href="${indexUrl}" rememberFocus="true" src="./images/dot.gif" onfocus="itemOnFocus('menu1','cartoonCastleMenuFocus');" onblur="itemOnBlur('menu1');" />
	</epg:if>
	</div>
	...
	<epg:img id="menu2" height="52" width="81" href="${indexUrl}" rememberFocus="true" src="./images/dot.gif" onfocus="itemOnFocus('menu2','cartoonCastleMenuFocus');" onblur="itemOnBlur('menu2');"/>
	</epg:if>
	</div>
	...
	<epg:img id="menu3" height="52" width="85" href="${indexUrl}" rememberFocus="true" src="./images/dot.gif" onfocus="itemOnFocus('menu3','cartoonCastleMenuFocus');" onblur="itemOnBlur('menu3');"/>
	</epg:if>
	</div>
	...
	<epg:img id="menu4" height="52" width="99" href="${indexUrl}" rememberFocus="true" src="./images/dot.gif" onfocus="itemOnFocus('menu4','cartoonCastleMenuFocus');" onblur="itemOnBlur('menu4');"/>
	</epg:if>
	</div>
  </div>
   <!--导航条end-->
   ...
   <!--上下页-->
	...
	<div style="position:absolute; left:417px; top:179px; width:108px; height:33px; line-height:33px;">
 	...
 	<!-- 栏目图片 -->
   	<epg:grid column="6" row="2" left="110" top="220" width="960" height="405" hcellspacing="32" vcellspacing="20" items="${category}" var="categoryItem"  indexVar="rowStatus" posVar="positions">
	 	<epg:if test="${categoryItem!=null}">
	 		<epg:navUrl obj="${categoryItem}" indexUrlVar="indexUrl"/>
	 		<epg:img id="listUp${rowStatus-1}" left="${positions[rowStatus-1].x}" top="${positions[rowStatus-1].y}"  style="border:2px solid #d1821b;" src="../${categoryItem.poster}"  width="130" height="190"/>
			<epg:img id="focus_${rowStatus-1}" src="./images/dot.gif"  href="${indexUrl}&returnTo=bizcat" rememberFocus="true" left="${positions[rowStatus-1].x-10}" top="${positions[rowStatus-1].y-7}" width="155" height="209"   onfocus="itemOnFocus('focus_${rowStatus-1}','nurseryContent');" onblur="itemOnBlur('focus_${rowStatus-1}');" />
		</epg:if>
    </epg:grid>
</div>
</epg:body>
