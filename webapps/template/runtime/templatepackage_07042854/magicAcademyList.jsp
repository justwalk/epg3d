...
<epg:body  onload="init();"  width="1280" height="720"  style="background-repeat:no-repeat;" defaultBg="./images/magicAcademy.jpg" bgcolor="#000000">
		...
		<epg:forEach begin="0" end="1" varStatus="colStatus">
			<epg:if test="${subjectResults[rowStatus.index*2+colStatus.index].title!=null}">
   		 		...
   		 		<epg:if test="${rowStatus.index*2+colStatus.index<9}">
   		 			...
   		 			<epg:img id="b${rowStatus.index*2+colStatus.index}" left="-13" top="${(rowStatus.index*2+colStatus.index)*42}" src="./images/dot.gif" href="${indexUrl}" rememberFocus="true" height="42" width="420"  onfocus="itemOnFocus('b${rowStatus.index*2+colStatus.index}','magicContentFocus');" onblur="itemOnBlur('b${rowStatus.index*2+colStatus.index}');"/>
   		 		</epg:if>
   		 		<epg:if test="${rowStatus.index*2+colStatus.index>8}">
   		 			...
   		 			<epg:img id="b${rowStatus.index*2+colStatus.index}"  left="412" top="${(rowStatus.index*2+colStatus.index)*42-378}" src="./images/dot.gif" href="${indexUrl}" rememberFocus="true" height="42" width="420" onfocus="itemOnFocus('b${rowStatus.index*2+colStatus.index}','magicContentFocus');" onblur="itemOnBlur('b${rowStatus.index*2+colStatus.index}');"/>
   		 		</epg:if>
   		 	</epg:if>
		</epg:forEach>
	</epg:forEach>
  ...
  <!--导航条start-->
	...
	<epg:img height="52" width="100"  href="${indexUrl}" id="top0" src="./images/dot.gif" onfocus="itemOnFocus('top0','magicGradeFocus');" onblur="itemOnBlur('top0');"/>
	</epg:if>
	</div>
	...
	<epg:img height="52" width="100" onfocus="itemOnFocus('top6')" href="${indexUrl}" rememberFocus="true" id="top6" src="./images/dot.gif" rememberFocus="true" onfocus="itemOnFocus('top6','magicGradeFocus');" onblur="itemOnBlur('top6');"/>
	</epg:if>
	</div>
  </div>
   ...
   <!--科目start-->
	...
	<epg:img height="117" width="80" onfocus="itemOnFocus('yuwen')" href="${indexUrl}" id="yuwen" src="./images/dot.gif" rememberFocus="true" onfocus="itemOnFocus('yuwen','magicSubjectFocus');" onblur="itemOnBlur('yuwen');"/>
	</epg:if>
	</div>
	...
	<epg:img height="117" width="80" onfocus="itemOnFocus('shuxue')" href="${indexUrl}" id="shuxue" src="./images/dot.gif" rememberFocus="true" onfocus="itemOnFocus('shuxue','magicSubjectFocus');" onblur="itemOnBlur('shuxue');"/>
	</epg:if>
	</div>
	...
	<epg:img height="117" width="80" onfocus="itemOnFocus('yingyu')" href="${indexUrl}" id="yingyu" src="./images/dot.gif" rememberFocus="true" onfocus="itemOnFocus('yingyu','magicSubjectFocus');" onblur="itemOnBlur('yingyu');"/>
	</epg:if>
	</div>
