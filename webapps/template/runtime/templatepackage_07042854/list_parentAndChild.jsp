  	...
  	<!-- 栏目文字-->
   	<epg:grid column="1" row="9" left="610" top="248" width="960" height="360" hcellspacing="32" vcellspacing="20" items="${category}" var="categoryItem"  indexVar="rowStatus" posVar="positions">
	 	<epg:if test="${categoryItem!=null}">
	 		...
	 		<epg:text id="listUp${rowStatus-1}" left="${positions[rowStatus-1].x}" top="${positions[rowStatus-1].y}" 
	 			rememberFocus="true"  height="33" width="378" text=""/>
   		 	<epg:img id="listUp${rowStatus-1}"  left="${positions[rowStatus-1].x-12}" top="${positions[rowStatus-1].y-2}" 
   		 		src="./images/dot.gif" href="${indexUrl}" rememberFocus="true" height="33" width="420" 
   		 		onfocus="itemOnFocus('listUp${rowStatus-1}','magicContentFocus');" onblur="itemOnBlur('listUp${rowStatus-1}');"/>
		</epg:if>
	</epg:grid>
	<!--导航条start-->
