...
<epg:grid column="6" row="1" left="350" top="90" width="880" height="45" hcellspacing="20" items="${menuCategoryItems}" var="menuCategoryItem"  indexVar="curIdx" posVar="positions">
	...
	<epg:if test="${curIdx==categoryType}">
		<epg:img src="./images/fazhitop${categoryType}.png"  left="${positions[curIdx-1].x}" top="${positions[curIdx-1].y}" width="130" height="45"/>
	</epg:if>
...
<!-- 左侧内容 -->
	...
	<epg:navUrl obj="${leftPicCategoryItems2}" indexUrlVar="indexUrl"/>
		...
		<epg:choose>
			<epg:when test="${!empty leftPicCategoryItems2.icon}">
				<epg:img id="leftCategory1"  rememberFocus="true" src="../${leftPicCategoryItems2.icon}" onblur="iconOnblur('contentImg0','leftItem0');" onfocus="iconOnfocus('contentImg0','orange1','leftItem0')" left="50" href="${indexUrl}&returnTo=biz" top="135" width="280" height="300"/>
			</epg:when>
			<epg:otherwise>
				<epg:img id="leftCategory1"  rememberFocus="true" src="../${leftPicCategoryItems2.itemIcon}" onblur="iconOnblur('contentImg0','leftItem0');" onfocus="iconOnfocus('contentImg0','orange1','leftItem0')" left="50" href="${indexUrl}&returnTo=biz" top="135" width="280" height="300"/>
			</epg:otherwise>
		</epg:choose>
