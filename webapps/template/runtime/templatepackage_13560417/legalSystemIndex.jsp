...
<epg:query queryName="getSeverialItemsIncludePic" maxRows="1" var="leftPicCategoryItems2" >
	<epg:param name="categoryCode" value="${templateParams['leftPicCategoryCode']}" type="java.lang.String"/>
</epg:query>
<!-- 左边推荐文字-->
...
<div id="leftDiv">
<!-- 背景图片以及头部图片 -->
<epg:img id="main"  defaultSrc="./images/legalSystemIndex.jpg" src="../${templateParams['backgroundImg']}"
	     left="0" top="0" width="640" height="720"/>

<epg:img src="./images/fazhitop1.png" left="175" top="90" width="65" height="45"/>
...
<epg:grid column="6" row="1" left="175" top="90" width="440" height="45" hcellspacing="20" items="${menuCategoryItems}" var="menuCategoryItem"  indexVar="curIdx" posVar="positions">
	...
	onfocus="buttonOnFocus('menu${curIdx}','fazhi${curIdx}');"  onblur="buttonOnBlur('menu${curIdx}');" 
...
<!-- 左侧内容 -->
	<epg:if test="${leftPicCategoryItems2!=null}">
	<epg:navUrl obj="${leftPicCategoryItems2}" indexUrlVar="indexUrl"/>
		...
		<epg:img id="leftCategory1"  rememberFocus="true" src="../${leftPicCategoryItems2.icon}" 
		...
		<div id="leftItem0"  style="position:absolute;font-size:22;font-family:'黑体';color:#ffffff;text-align:center;background-color:#020000;left:25px;top:392px;width:140px;height:44px;opacity:0.8;" >
			<epg:text left="5" color="#ffffff" top="10" height="22" chineseCharNumber="12" width="140" fontSize="14" dotdotdot="…">
			${leftPicCategoryItems2.title}
			</epg:text>
		</div>
	</epg:if>
	...
	<epg:navUrl obj="${leftCategoryItems[0]}" indexUrlVar="indexUrl"/>
		...
		<epg:text left="30" color="#003333" top="447" height="22" id="leftCategory2"
		 chineseCharNumber="12" width="140" fontSize="14"  dotdotdot="…">
...
<div style="position:absolute; top:165px; left:332px; width:65px; height:22px; font-size:14px; " >
...
<!--中间文字 -->
<div style="position:absolute;left:175px;top:212px;width:880px;height:450px">
...
<epg:forEach begin="0" end="9" varStatus="rowStatus">
	...
	<epg:navUrl obj="${rightCategoryItems[colStatus.index*10+rowStatus.index]}" indexUrlVar="indexUrl"/>
		<epg:if test="${colStatus.index*10+rowStatus.index<10}">
			...
			<epg:text id="categoryList${colStatus.index*10+rowStatus.index}" left="25" top="${rowStatus.index*45+15}" width="388" height="45" color="#333333" chineseCharNumber="16" fontSize="14" dotdotdot="…">
			${rightCategoryItems[colStatus.index*10+rowStatus.index].title}</epg:text>
		</epg:if>
		<epg:if test="${colStatus.index*10+rowStatus.index>=10}">
			<epg:img id="categoryList${colStatus.index*10+rowStatus.index}" left="450" top="${rowStatus.index*45}" width="215" height="45" rememberFocus="true" src="./images/dot.gif" 
			 href="${indexUrl}&pageIndex=${pageBean.pageIndex}&returnTo=biz"  onfocus="textOnFocus('categoryList${colStatus.index*10+rowStatus.index}','#ffffff')" onblur="textOnBlur('categoryList${colStatus.index*10+rowStatus.index}','#333')" />
			<epg:text id="categoryList${colStatus.index*10+rowStatus.index}" left="250" top="${rowStatus.index*45+15}" width="388" height="26" color="#333333" chineseCharNumber="16" fontSize="14" dotdotdot="…">
			${rightCategoryItems[colStatus.index*10+rowStatus.index].title}</epg:text>
		</epg:if>
	</epg:if>
</epg:forEach>
...
<div id="r_rightDiv">
<!-- 背景图片以及头部图片 -->
<epg:img id="r_main"  defaultSrc="./images/legalSystemIndex.jpg" src="../${templateParams['backgroundImg']}"
	     left="640" top="0" width="640" height="720"/>

<epg:img src="./images/fazhitop1.png" left="815" top="90" width="65" height="45"/>
...
<!-- 左侧内容 -->
	...
	<epg:navUrl obj="${leftPicCategoryItems2}" indexUrlVar="indexUrl"/>
		...
		<epg:img id="r_leftCategory1"  rememberFocus="true" src="../${leftPicCategoryItems2.icon}" 
		onblur="iconOnblur('contentImg0','leftItem0');" onfocus="iconOnfocus('contentImg0','orange1','leftItem0')"
		left="675" href="${indexUrl}&returnTo=biz" top="135" width="140" height="300"/>
		<div id="r_leftItem0"  style="position:absolute;font-size:22;font-family:'黑体';color:#ffffff;text-align:center;background-color:#020000;left:675px;top:392px;width:140px;height:44px;opacity:0.8;" >
			<epg:text left="5" color="#ffffff" top="10" height="22" chineseCharNumber="12" width="140" fontSize="14" dotdotdot="…">
			${leftPicCategoryItems2.title}
			</epg:text>
		</div>
...
<div style="position:absolute; top:165px; left:972px; width:65px; height:22px; font-size:14px; " >
...
<!--中间文字 -->
<div style="position:absolute;left:815px;top:212px;width:880px;height:450px">
<epg:forEach begin="0" end="1" varStatus="colStatus">
<epg:forEach begin="0" end="9" varStatus="rowStatus">
	<epg:if test="${rightCategoryItems[colStatus.index*10+rowStatus.index]!=null}">
	<epg:navUrl obj="${rightCategoryItems[colStatus.index*10+rowStatus.index]}" indexUrlVar="indexUrl"/>
		<epg:if test="${colStatus.index*10+rowStatus.index<10}">
			<epg:img id="r_categoryList${colStatus.index*10+rowStatus.index}" left="0" top="${rowStatus.index*45}" width="215" height="45" rememberFocus="true" src="./images/dot.gif" 
			 href="${indexUrl}&pageIndex=${pageBean.pageIndex}&returnTo=biz"  onfocus="textOnFocus('categoryList${colStatus.index*10+rowStatus.index}','#ffffff')" onblur="textOnBlur('categoryList${colStatus.index*10+rowStatus.index}','#333')"/>
			<epg:text id="r_categoryList${colStatus.index*10+rowStatus.index}" left="25" top="${rowStatus.index*45+15}" width="388" height="45" color="#333333" chineseCharNumber="16" fontSize="14" dotdotdot="…">
			${rightCategoryItems[colStatus.index*10+rowStatus.index].title}</epg:text>
		</epg:if>
		<epg:if test="${colStatus.index*10+rowStatus.index>=10}">
			<epg:img id="r_categoryList${colStatus.index*10+rowStatus.index}" left="225" top="${rowStatus.index*45}" width="215" height="45" rememberFocus="true" src="./images/dot.gif" 
			 href="${indexUrl}&pageIndex=${pageBean.pageIndex}&returnTo=biz"  onfocus="textOnFocus('categoryList${colStatus.index*10+rowStatus.index}','#ffffff')" onblur="textOnBlur('categoryList${colStatus.index*10+rowStatus.index}','#333')" />
			<epg:text id="r_categoryList${colStatus.index*10+rowStatus.index}" left="250" top="${rowStatus.index*45+15}" width="388" height="26" color="#333333" chineseCharNumber="16" fontSize="14" dotdotdot="…">
			${rightCategoryItems[colStatus.index*10+rowStatus.index].title}</epg:text>
		</epg:if>
	</epg:if>
</epg:forEach>
