	...
	<div id="leftDiv">
		...
		<epg:if test="${leftCategoryItems[0] !=null}">
			...
			<div id="lf1_bg" style="position: absolute; left: 25px; top: 527px; width: 140px; height: 40px;">
				<epg:img id="lf1" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play1.html" onblur="textOnBlur('lf1','#02296d','#c0d9ea');" onfocus="textOnFocus('lf1','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[0] != null}">
			<epg:text id="lf1_text"  left="25" top="536" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">自然风景</epg:text>
		</epg:if>
		...
		<epg:if test="${leftCategoryItems[1] !=null}">
			...
			<div id="lf2_bg" style="position: absolute; left: 25px; top: 569px; width: 140px; height: 40px;">
				<epg:img id="lf2" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play2.html" onblur="textOnBlur('lf2','#02296d','#c0d9ea');" onfocus="textOnFocus('lf2','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[1] != null}">
			<epg:text id="lf2_text"  left="25" top="576" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">创维</epg:text>
		</epg:if>
		...
		<epg:if test="${leftCategoryItems[2] !=null}">
			...
			<div id="lf3_bg" style="position: absolute; left: 25px; top: 611px; width: 140px; height: 40px;">
				<epg:img id="lf3" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play3.html" onblur="textOnBlur('lf3','#02296d','#c0d9ea');" onfocus="textOnFocus('lf3','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[2] != null}">
			<epg:text id="lf3_text" left="25" top="619" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">小熊</epg:text>
		</epg:if>
		...
		<epg:grid column="2" row="3" left="175" top="226" width="240" height="426" vcellspacing="10" hcellspacing="10" items="${centerCategoryItems}" var="centerCategoryItem" indexVar="curIdx"
			...
			<epg:img id="midContentFocus${curIdx-1}" onblur="iconOnblur('midContent${curIdx-1}',1)" onfocus="iconOnfocus('midContent${curIdx-1}',1)" rememberFocus="true" src="./images/dot.gif"
				left="${positions[curIdx-1].x-3}" top="${positions[curIdx-1].y-3}" width="121" height="146" href="${context['EPG_CONTEXT']}/3DPlay/${positions[curIdx-1].x + positions[curIdx-1].y}.html" />
		...
		<epg:grid column="2" row="1" left="425" top="224" width="190" height="190" hcellspacing="10" items="${rightUpCategoryItems}" var="rightUpCategoryItem" indexVar="curIdx" posVar="positions">
			...
			<epg:img id="rightUpContentFocus${curIdx-1}" onblur="iconOnblur('rightUpContent${curIdx-1}',1)" onfocus="iconOnfocus('rightUpContent${curIdx-1}',1)" rememberFocus="true" src="./images/dot.gif"
				left="${positions[curIdx-1].x-3}" top="${positions[curIdx-1].y-3}" width="93" height="190" href="${context['EPG_CONTEXT']}/3DPlay/${positions[curIdx-1].x + positions[curIdx-1].y}.html" />
		</epg:grid>
	...
	<div id="rightDiv">
		...
		<epg:if test="${leftCategoryItems[0] !=null}">
			...
			<div id="r_lf1_bg" style="position: absolute; left: 665px; top: 527px; width: 140px; height: 40px;">
				<epg:img id="r_lf1" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play1.html" onblur="textOnBlur('lf1','#02296d','#c0d9ea');" onfocus="textOnFocus('lf1','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[0] != null}">
			<epg:text id="r_lf1_text" left="665" top="536" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">自然风景</epg:text>
		</epg:if>
		...
		<epg:if test="${leftCategoryItems[1] !=null}">
			...
			<div id="r_lf2_bg" style="position: absolute; left: 665px; top: 569px; width: 140px; height: 40px;">
				<epg:img id="r_lf2" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play2.html" onblur="textOnBlur('lf2','#02296d','#c0d9ea');" onfocus="textOnFocus('lf2','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[1] != null}">
			<epg:text id="r_lf2_text" left="665" top="576" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">创维</epg:text>
		</epg:if>

		<epg:if test="${leftCategoryItems[2] !=null}">
			<epg:navUrl obj="${leftCategoryItems[2]}" indexUrlVar="indexUrl" />
			<div id="r_lf3_bg" style="position: absolute; left: 665px; top: 611px; width: 140px; height: 40px;">
				<epg:img id="r_lf3" width="140" height="40" rememberFocus="true" href="${context['EPG_CONTEXT']}/3DPlay/play3.html" onblur="textOnBlur('lf3','#02296d','#c0d9ea');" onfocus="textOnFocus('lf3','#ffffff','#f79922')"
					src="./images/dot.gif" />
			</div>
		</epg:if>
		<epg:if test="${leftCategoryItems[2] != null}">
			<epg:text id="r_lf3_text" left="665" top="619" color="#02296d" width="134" chineseCharNumber="12" dotdotdot="…">小熊</epg:text>
		</epg:if>
