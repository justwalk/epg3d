...
%>
<epg:html>
<head linkcolor="#fcb393" visitedcolor="#ffff00">
</head>
<!-- menu -->
...
<!-- 获取栏目图片-->
<epg:query queryName="getCategoryByCode" maxRows="1" var="picCategory" >
	<epg:param name="categoryCode" value="${context['EPG_CATEGORY_CODE']}" type="java.lang.String"/>
</epg:query>
...
<epg:query queryName="getSeverialItems" maxRows="15" var="rightCategoryItems2" >
...
<%-- 
<!--右侧固定栏目1 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem1" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory1']}" type="java.lang.String"/>
</epg:query>
<!--右侧固定栏目2 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem2" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory2']}" type="java.lang.String"/>
</epg:query>
<!--右侧固定栏目3 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem3" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory3']}" type="java.lang.String"/>
</epg:query>
<!--右侧固定栏目4 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem4" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory4']}" type="java.lang.String"/>
</epg:query>
<!--右侧固定栏目5 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem5" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory5']}" type="java.lang.String"/>
</epg:query>
<!--右侧固定栏目6 -->
<epg:query queryName="getCategoryByCode" maxRows="1" var="rightCategoryItem6" >
	<epg:param name="categoryCode" value="${templateParams['rightCategory6']}" type="java.lang.String"/>
</epg:query>
--%>
<style type="text/css">
...
<epg:body onload="init()"  defaultBg="./images/back_GT.jpg" background="../${templateParams['bgImg']}" width="1280" height="720" bgcolor="#000000" style="background-repeat:no-repeat;">
...
<epg:img id="up_focus" onfocus="itemOnFocus('up','gossipPageup')" onblur="itemOnBlur('up')" src="./images/dot.gif" left="295" top="117" width="127" height="47" href="javascript:pageUp();" />

<epg:img id="down_focus" onfocus="itemOnFocus('down','gossipPagedown')" onblur="itemOnBlur('down')"   src="./images/dot.gif" left="426" top="117"  width="127" height="47"  href="javascript:pageDown();" />

<epg:img id="back2_focus" onfocus="itemOnFocus('back2','back_GT')" onblur="itemOnBlur('back2')"   src="./images/dot.gif" left="650" top="117"  width="127" height="47"  href="${menu1Url}" />

<epg:img id="back_focus" onfocus="itemOnFocus('back','focusBackHome')" onblur="itemOnBlur('back')"  src="./images/dot.gif" left="1126" top="76" width="110" height="60" href="${returnBizUrl}" />
	
<!-- 栏目内容 -->
<epg:if test="${picCategory!=null}">
<epg:text  align="center" left="93" top="128"  width="190" height="30" fontSize="24" color="#fff" text="${picCategory.title}" chineseCharNumber="8" dotdotdot="…"/>
</epg:if>
...
<!-- 右侧推荐栏目 -->
	...
	<epg:img   src="../${rightCategoryItems1[0].itemIcon}" left="662" top="170" style="border:4px solid #b86668;" width="250" height="130"/>
	 <epg:img id="rightPic0_focus" src="./images/dot.gif" left="654" top="166" width="273"  height="148"/>
	<epg:img id="rightPic0" src="./images/dot.gif"  rememberFocus="true" left="659" top="171" width="263"  height="138" href="${indexUrl}"
	...
	<epg:img id="rightPic1" src="./images/dot.gif"  rememberFocus="true" left="933" top="171" width="263"  height="138" href="${indexUrl}"
	...
	<epg:img id="rightPic2_focus" src="./images/dot.gif" left="654" top="336" width="273"  height="148"/>
	<epg:img id="rightPic2" src="./images/dot.gif"  rememberFocus="true" left="659" top="341" width="263"  height="138"  href="${indexUrl}"
	...
	<epg:img id="rightPic3_focus" src="./images/dot.gif" left="928" top="336" width="273"  height="148"/>
	<epg:img id="rightPic3" src="./images/dot.gif" rememberFocus="true" left="933" top="341" width="263"  height="138"  href="${indexUrl}"
	...
	<epg:img id="rightPic4_focus" src="./images/dot.gif" left="654" top="506" width="273"  height="148"/>
	<epg:img id="rightPic4" src="./images/dot.gif" rememberFocus="true" left="659" top="511" width="263"  height="138" href="${indexUrl}"
	 onfocus="itemOnFocus('rightPic4','selectedImg');"  onblur="itemOnBlur('rightPic4');"/>
	
	<epg:navUrl obj="${rightCategoryItems2[13]}" indexUrlVar="indexUrl" ></epg:navUrl>
	<epg:img  src="../${rightCategoryItems2[13].itemIcon}" left="936" top="510" style="border:4px solid #b86668;" width="250" height="130"/>
	<epg:img id="rightPic5_focus" src="./images/dot.gif" left="928" top="506" width="273"  height="148"/>
	<epg:img id="rightPic5" src="./images/dot.gif" rememberFocus="true" left="933" top="511" width="263"  height="138" href="${indexUrl}"
