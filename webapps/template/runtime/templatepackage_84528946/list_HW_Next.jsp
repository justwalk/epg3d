...
<epg:img id="back2_focus" onfocus="itemOnFocus('back2','back_HW')" onblur="itemOnBlur('back2')"   src="./images/dot.gif" left="650" top="117"  width="127" height="47"  href="${menu3Url}" />
