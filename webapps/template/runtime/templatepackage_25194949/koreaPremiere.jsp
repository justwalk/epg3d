...
<div id="leftDiv">
	<epg:img defaultSrc="./images/hanguo2.jpg" src="../${templateParams['backgroundImg']}" width="640" height="720" left="0"/>
...
<epg:img id="pageUp" left="169" top="177" width="65" height="32" src="./images/dot.gif" href="javascript:pageUp();"
...
<epg:img id="pageDownFocus"src="./images/dot.png" left="243" top="174"
	 width="65" height="32" style="border:3px solid #0bebff;visibility: hidden;" />
<epg:img id="pageDown" left="244" top="177" width="65" height="32" src="./images/dot.gif" href="javascript:pageDown();"
		onblur="iconOnblur('pageDownFocus');" onfocus="iconOnfocus('pageDownFocus')" pageop="down" keyop="pagedown"/>
<epg:text left="334" top="178" width="50" height="24" color="#21101d" fontSize="12" align="left" fontFamily="黑体"
		  text="${pageBean.pageIndex}/${pageBean.pageCount} 页"/>
	
<!-- contents -->
<epg:grid left="169" top="218" width="440" height="431" row="2" column="6" items="${rightCategoryItems}"
	...
	<epg:if test="${pageBean.pageIndex == 1 && curIdx <= 6}">
		...
		<epg:text left="${positions[curIdx-1].x+8}" top="${positions[curIdx-1].y+210}" width="65" height="50"
				  color="#999999" dotdotdot="" fontSize="8" fontFamily="黑体">更新至第     集</epg:text>
		<epg:text left="${positions[curIdx-1].x+40}" top="${positions[curIdx-1].y+205}" width="17" height="50"
...
<epg:if test="${leftCategoryItems != null}">	
	<epg:img id="left0" left="34" top="177" width="110" onblur="iconOnblur('leftContent0');" onfocus="iconOnfocus('leftContent0')" href="${leftCategoryIndexUrl}&pi=1&returnTo=biz" rememberFocus="true" height="330" src="../${leftCategoryItems.icon}" />
</epg:if>
...
<epg:if test="${leftCategoryItems != null}">
	<epg:text left="40" top="529" width="100" height="50" color="#f1d4ff" chineseCharNumber="8" dotdotdot=" " fontSize="18" align="center" fontFamily="黑体" text="${leftCategoryItems.title}"/>
...
<!-- ****************************************************** -->
<div id="r_leftDiv">
	<epg:img defaultSrc="./images/hanguo2.jpg" src="../${templateParams['backgroundImg']}" width="640" height="720" left="640"/>

<!-- pageTurn -->
<epg:img id="r_pageUpFocus" src="./images/dot.png" left="808" top="174"
	 width="65" height="32" style="border:3px solid #0bebff;visibility: hidden;" />
<epg:img id="r_pageUp" left="809" top="177" width="65" height="32" src="./images/dot.gif" href="javascript:pageUp();"
 	 	onblur="iconOnblur('pageUpFocus');" onfocus="iconOnfocus('pageUpFocus')" pageop="up" keyop="pageup"/>
<epg:img id="r_pageDownFocus"src="./images/dot.png" left="883" top="174"
	 width="65" height="32" style="border:3px solid #0bebff;visibility: hidden;" />
<epg:img id="r_pageDown" left="884" top="177" width="65" height="32" src="./images/dot.gif" href="javascript:pageDown();"
		onblur="iconOnblur('pageDownFocus');" onfocus="iconOnfocus('pageDownFocus')" pageop="down" keyop="pagedown"/>
<epg:text left="974" top="178" width="50" height="24" color="#21101d" fontSize="12" align="left" fontFamily="黑体"
		  text="${pageBean.pageIndex}/${pageBean.pageCount} 页"/>
	
<!-- contents -->
<epg:grid left="819" top="218" width="440" height="431" row="2" column="6" items="${rightCategoryItems}"
		  var="rightCategoryItem" indexVar="curIdx" posVar="positions" hcellspacing="20" vcellspacing="42">
	<epg:navUrl obj="${rightCategoryItem}" indexUrlVar="indexUrl"/>
...
<epg:if test="${leftCategoryItems != null}">	
	<epg:img id="r_left0" left="684" top="177" width="110" onblur="iconOnblur('leftContent0');" onfocus="iconOnfocus('leftContent0')" href="${leftCategoryIndexUrl}&pi=1&returnTo=biz" rememberFocus="true" height="330" src="../${leftCategoryItems.icon}" />
</epg:if>
...
<epg:if test="${leftCategoryItems != null}">
	<epg:text left="680" top="529" width="100" height="50" color="#f1d4ff" chineseCharNumber="8" dotdotdot=" " fontSize="18" align="center" fontFamily="黑体" text="${leftCategoryItems.title}"/>
