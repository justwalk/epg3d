...
-- ----------------------------
ALTER TABLE EPG_CONTENT_PROGRAM ADD `HD_TYPE` int(11) DEFAULT '0', ADD `REL_CODE` varchar(128) DEFAULT NULL;
-- ----------------------------
-- Table structure for EPG_CONTENT_SERIES 如果数据库表中已有HD_TYPE则不要ADD
-- ----------------------------
ALTER TABLE EPG_CONTENT_SERIES ADD `HD_TYPE` int(11) DEFAULT '0', ADD `REL_CODE` varchar(128) DEFAULT NULL;
-- ----------------------------
